...
എന്നെ ഉണ്ടാക്കിയത് എന്റെ മൊതലാളി @devil_spy ആണ് ഹായ് {}, എന്റെ പേര് {}! ഞാൻ [ഇദ്ദേഹം](tg://user?id={}) നോക്കി നടത്തുന്ന ഒരു അടിപൊളി അഡ്മിൻ ബോട്ടാണ്.
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="🤖 Make Own Admin Bot", url="https://t.me/Keralamarket")],
                     [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/Keralamarket"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/Keralamarkets")],
                     [InlineKeyboardButton(text="🎬 Youtube Channel", url="https://t.me/Keralamarket"), InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))
